  ...
  return(
    <div className="card">
      ...
      <div className="content-summary">
          <h1 className="card-title">Content Project Summary</h1>
          ...
          <button className="btn btn-outline-primary"  data-toggle="collapse" data-target="#collapseContent" aria-expanded="false" aria-controls="collapseContent">View Details</button>
      </div>
      </div>
    </div>
  )
