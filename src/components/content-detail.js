  ...
  return(
    <div>
      ...
      <div className="content-detail collapse"  id="collapseContent">
          <div><i onClick={props.viewSwitch} className="fa fa-expand fa-lg" aria-hidden="true"></i> <h1 className="content-title card-block ml-3 center-align">{props.name}</h1></div>
